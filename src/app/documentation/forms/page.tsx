...
const CODE_CHECKBOX_STLYES = `const checkboxStyles = 'relative bg-scaffold rounded-md min-h-5 min-w-5 cursor-pointer appearance-none border border-default checked:before:absolute checked:before:top-1/2 checked:before:left-1/2 checked:before:w-[1rem] checked:before:h-[1rem] checked:before:leading-none checked:before:-translate-x-1/2 checked:before:-translate-y-1/2 checked:before:content-checkmark-icon checked:before:brightness-0 dark:checked:before:brightness-200'
`

const CODE_RADIO_STLYES = `const radioStyles = "appearance-none cursor-pointer min-w-5 min-h-5 bg-scaffold border border-default rounded-full relative checked:before:absolute checked:before:-translate-y-1/2 checked:before:-translate-x-1/2 checked:before:top-1/2 checked:before:left-1/2 checked:before:content-[''] checked:before:w-[0.6rem] checked:before:h-[0.6rem] checked:before:rounded-full checked:before:bg-contrast disabled:cursor-not-allowed disabled:opacity-50"
`
...
const CODE_RANGE_STLYES = `const rangeStyles = 'appearance-none focus:outline-none cursor-pointer h-2 border border-default bg-scaffold rounded-full disabled:cursor-not-allowed disabled:opacity-50 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:bg-contrast [&::-webkit-slider-thumb]:border-0 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:focus:outline-none [&::-webkit-slider-thumb]:focus:ring-2 [&::-webkit-slider-thumb]:focus:ring-offset-2 [&::-webkit-slider-thumb]:focus:ring-default [&::-webkit-slider-thumb]:focus:dark:ring-offset-scaffold [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:bg-contrast [&::-moz-range-thumb]:border-0 [&::-moz-range-thumb]:w-4 [&::-moz-range-thumb]:h-4 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:focus:outline-none [&::-moz-range-thumb]:focus:ring-2 [&::-moz-range-thumb]:focus:ring-offset-2 [&::-moz-range-thumb]:focus:ring-default [&::-moz-range-thumb]:focus:dark:ring-offset-scaffold'
`

const CODE_DATEPICKER_STLYES = `const datePickerStyles = 'appearance-none font-sans w-full rounded-lg border border-default bg-scaffold px-3 py-2 file:border-0 file:bg-transparent file:font-medium placeholder:placeholder-default focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-0 focus-visible:ring-default disabled:cursor-not-allowed disabled:opacity-50'
`
