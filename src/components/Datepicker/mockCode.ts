...
const datePickerStyles =
  'border-default bg-scaffold placeholder:placeholder-muted focus-visible:ring-default w-full appearance-none rounded-lg border px-3 py-2 font-sans file:border-0 file:bg-transparent file:font-medium focus-visible:ring-2 focus-visible:ring-offset-0 focus-visible:outline-hidden disabled:cursor-not-allowed disabled:opacity-50'
