...
const checkboxStyles =
  'relative bg-scaffold rounded-md min-h-5 min-w-5 cursor-pointer appearance-none border border-muted checked:before:absolute checked:before:top-1/2 checked:before:left-1/2 checked:before:w-[1rem] checked:before:h-[1rem] checked:before:leading-none checked:before:-translate-x-1/2 checked:before:-translate-y-1/2 checked:before:content-checkmark-icon checked:before:brightness-0 dark:checked:before:brightness-200'
const radioStyles =
  "appearance-none cursor-pointer min-w-5 min-h-5 bg-scaffold border border-muted rounded-full relative checked:before:absolute checked:before:-translate-y-1/2 checked:before:-translate-x-1/2 checked:before:top-1/2 checked:before:left-1/2 checked:before:content-[''] checked:before:w-[0.6rem] checked:before:h-[0.6rem] checked:before:rounded-full checked:before:bg-contrast disabled:cursor-not-allowed disabled:opacity-50"
