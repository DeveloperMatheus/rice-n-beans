...
const checkboxStyles =
  "relative bg-white dark:bg-zinc-950 rounded-md min-h-5 min-w-5 cursor-pointer appearance-none border border-zinc-200 dark:border-zinc-800 checked:before:absolute checked:before:top-1/2 checked:before:left-1/2 checked:before:w-[1rem] checked:before:h-[1rem] checked:before:leading-none checked:before:-translate-x-1/2 checked:before:-translate-y-1/2 checked:before:[clip-path:polygon(24.82%_34.04%,_41%_53%,_76.9%_22.38%,_88.56%_35.78%,_40%_78%,_11.59%_45.33%)] checked:before:bg-black dark:checked:before:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 dark:ring-offset-zinc-950 dark:focus:ring-zinc-300";
const radioStyles =
