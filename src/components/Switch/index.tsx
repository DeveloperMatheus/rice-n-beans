...
const switchStyles =
  'border-default bg-scaffold checked:bg-success before:bg-contrast relative min-h-6 min-w-10 cursor-pointer appearance-none rounded-full border before:absolute before:top-1/2 before:left-1 before:h-2.5 before:w-2.5 before:-translate-y-1/2 before:rounded-full before:transition-all checked:before:left-6 checked:before:bg-white disabled:cursor-not-allowed disabled:opacity-30'
